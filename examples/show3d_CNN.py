...
from gs_sdk import gs_reconstructCNN
from gs_sdk.gs_reconstructCNN import calc_depth_map
...
def main():
    ...
    recon = gs_reconstructCNN.ReconstructorCNN(args.model_path, device=gpuorcpu)
